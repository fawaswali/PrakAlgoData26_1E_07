...
public class BinaryTreeMain07 {
    public static void main(String[] args) {
        ...
        bst.add(new Mahasiswa07("244160221","Badar","B",3.85));
        bst.add(new Mahasiswa07("244160185","Candra","C",3.21));
        bst.add(new Mahasiswa07("244160220","Dewi","B",3.54));
        ...
        bst.delete(3.57);
        System.out.println("\nDaftar semua mahasiswa setelah pengahapusan 1 mahasiswa (in order traversal):");
        bst.traverseInOrder(bst.root);
